...
-- ============================================================================
-- which-key 插件高亮组（让面板跟随主题）
-- ============================================================================
local wk_groups = {
	"WhichKey", -- 按键名称
	"WhichKeyDesc", -- 按键描述
	"WhichKeySeparator", -- 分隔符
	"WhichKeyFloat", -- 浮窗背景
	"WhichKeyBorder", -- 浮窗边框
	"WhichKeyTitle", -- 标题
	"WhichKeyGroup", -- 分组名称
...
-- 设置浮窗背景与编辑器背景一致
vim.api.nvim_set_hl(0, "WhichKeyFloat", { bg = "{{colors.background.default.hex}}" })
vim.api.nvim_set_hl(0, "WhichKeyBorder", { fg = "{{colors.primary.default.hex}}" })
vim.api.nvim_set_hl(0, "WhichKey", { fg = "{{colors.on_background.default.hex}}" })
vim.api.nvim_set_hl(0, "WhichKeyDesc", { fg = "{{colors.on_surface_variant.default.hex}}" })
vim.api.nvim_set_hl(0, "WhichKeySeparator", { fg = "{{colors.outline.default.hex}}" })
vim.api.nvim_set_hl(0, "WhichKeyGroup", { fg = "{{colors.primary.default.hex}}", bold = true })
vim.api.nvim_set_hl(0, "WhichKeyTitle", { fg = "{{colors.primary.default.hex}}", bold = true })
